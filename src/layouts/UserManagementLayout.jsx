    ...
    return (
        <div className="management_container">
            <div className="management_wrapper flex">
                ...
                <div className="management_right basis-[80%] h-[100vh]  bg-[#FAFAFA]">
                    <div className='flex justify-center '>
                        <div className='w-[100%] '>
                            <div className="management_right_top w-[100%] h-[9dvh] justify-center flex items-center  bg-white">
                            ...
                            <div className='flex  justify-center items-center h-[91dvh]'>
                                <div className="management_right_bottom_children flex  w-[95%] h-[100%]">
                                    <Outlet />
                                </div>
                            </div>
                        </div>
